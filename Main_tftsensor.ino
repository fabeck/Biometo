...
void loop() {
  ...
  {
    myFile.print(F("Pulse:"));
    myFile.print(MySignals.pulsioximeterData.BPM);
    myFile.print(F("bpm / SPO2:"));
    myFile.print(MySignals.pulsioximeterData.O2);
    myFile.println(F("%"));
  }
  else if (pulsioximeter_state == 2)
  {
    myFile.println(F("Not valid data"));
  }
  else
  {
    myFile.println(F("No available data"));
  }
